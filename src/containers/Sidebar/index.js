                ...
                <Nav vertical className="list-unstyled">
                  <NavItem
                      className={classnames({
                        active: ((this.state.selectedParentMenu == "product" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="product")
                      })}
                  >
                    <NavLink
                        to="/admin/product"
                        onClick={e => this.openSubMenu(e, "product")}
                    >
                  ...
                  >
                    <NavLink
                        to="/admin/category"
                        onClick={e => this.openSubMenu(e, "category")}
                    >
                  ...
                  <NavItem
                      className={classnames({
                        active: ((this.state.selectedParentMenu == "carousel" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="carousel")
                      })}
                  >
                    <NavLink
                        to="/admin/carousel"
                        onClick={e => this.openSubMenu(e, "carousel")}
                    >
                  ...
                  <NavItem
                      className={classnames({
                        active: ((this.state.selectedParentMenu == "account" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="account")
                      })}
                  >
                    <NavLink
                        to="/admin/account"
                        onClick={e => this.openSubMenu(e, "account")}
                    >
          ...
          <div className="sub-menu">
            <div className="scroll">
              ...
              >
                <Nav
                    className={classnames({
                      "d-block": ((this.state.selectedParentMenu == "product" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="product")
                    })}
                    data-parent="product"
                >
                  <NavItem>
                ...
                <Nav
                    className={classnames({
                      "d-block": ((this.state.selectedParentMenu == "category" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="category")
                    })}
                ...
                <Nav
                    className={classnames({
                      "d-block": ((this.state.selectedParentMenu == "carousel" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="carousel")
                    })}
                    data-parent="carousel"
                >
                  <NavItem>
                    <NavLink to="/admin/carousel/list">
                      <i className="simple-icon-list" />{" "}
                      Danh sách
                    </NavLink>
                  </NavItem>
                ...
                <Nav
                    className={classnames({
                      "d-block": ((this.state.selectedParentMenu == "account" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="account")
                    })}
                    data-parent="account"
                >
                  <NavItem>
                    <NavLink to="/admin/account/list">
                      <i className="far fa-list-alt"></i>{" "}
                      <IntlMessages id="menu.account.list" />
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink to="/admin/account/group">
                ...
                <Nav
                    className={classnames({
                      "d-block": ((this.state.selectedParentMenu == "role" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="role")
                    })}
                    data-parent="role"
                >
                  <NavItem>
                    <NavLink to="/admin/role/list">
                      <i className="far fa-list-alt"></i>{" "}
                      <IntlMessages id="menu.role.list" />
                    </NavLink>
                  </NavItem>
                </Nav>
