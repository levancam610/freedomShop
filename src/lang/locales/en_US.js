...
module.exports = {
  ...
  "header.label.description": "Description",
  "header.label.create.date": "Create date",
  "header.label.update.date": "Update",
  "header.label.action": "Action",


  /* ALL */
  "label.search": "Tìm kiếm",
  "label.orderby": "Order by: ",
  "label.of": "of",
  "label.all":"All",
  "label.order.by.create": "Create date",
  "label.order.by.name": "Name",
...
/* ACCOUNT GROUP */
  "account.group.table.header.name":"Name",
  "account.group.table.header.description":"Description",
  "account.group.table.header.createDate":"Create date",
  "account.group.table.header.update":"Update",
  "account.group.table.header.shop":"Shop",
  "account.group.table.header.action":"Action",
  "layouts.description": "Description",
  "modal.add.shop": "Choose shop",
  "modal.select.shop.placeholder": "Choose a shop",
  "modal.edit.accountGroup": "Update info account group",
  "validation.form.not.empty": "Field not empty",
  "modal.account.group.add.title":"Add new account group",

  /* ACCOUNT */
  "account.table.header.name": "Name",
  "account.table.header.username": "Username",
  "account.table.header.birth.day": "Birth day",
  "account.table.header.phone": "Phone number",

  /* PRODUCT */
  "product.header.name": "Product",
