...
module.exports = {
  ...
  /* DATA TABLE */
  "header.label.name": "Tên",
  "header.label.description": "Mô tả",
  "header.label.create.date": "Ngày tạo",
  "header.label.update.date": "Ngày cập nhật",
  "header.label.action": "Thao tác",

  /* ALL */
  "label.search": "Search",
  "label.orderby": "Sắp xếp: ",
  "label.of": "của",
  "label.all":"Tất cả",
  "label.order.by.create": "Ngày tạo",
  "label.order.by.name": "Tên",
  "label.order.by.username": "User name",
  "label.name":"Tên",
  ...
  "button.add.new": "THÊM MỚI",

  /* MENU */
  "account.group.table.header.name":"Tên",
  "account.group.table.header.description":"Mô tả",
  "account.group.table.header.createDate":"Ngày tạo",
  "account.group.table.header.update":"Ngày cập nhập",
  "account.group.table.header.shop":"Cửa hàng",
  "account.group.table.header.action":"Thao tác",
  "menu.product": "Sản phẩm",
  "menu.license": "Giấy phép",
  "menu.account": "Tài khoản",
  "menu.account.list": "Danh sách tài khoản",
  "menu.account.group": "Nhóm tài khoản",
  "menu.group": "Nhóm",
  "menu.role": "Quyền",
  "menu.role.list": "Danh sách quyền",
  "menu.admin": "Trang chủ",
  /* ACCOUNT GROUP */
  "layouts.description": "Mô tả",
  "modal.add.shop": "Choose shop",
  "modal.select.shop.placeholder": "Chọn cửa hàng",
  "modal.edit.accountGroup": "Cập nhật nhóm tài khoản",
  "validation.form.not.empty": "Trường bắt buộc nhập",
  "modal.account.group.add.title":"Thêm mới nhóm tài khoản",

  /* ACCOUNT */
  "account.table.header.name": "Họ tên",
  "account.table.header.username": "Tài khoản",
  "account.table.header.birth.day": "Ngày sinh",
  "account.table.header.phone": "Số điện thoại",

  /* PRODUCT */
  "product.header.name": "Sản phẩm",
  ...
  "menu.list": "List",
  "menu.category": "type.js",
  "menu.license": "License",
  "menu.licenseType": "Type",
  "menu.app": "Home",
  ...
  "lp.team.detail-1": "Our team brings a wealth of experience from some of the world’server most formidable production studios, agencies and startups.",
  ...
  "lp.timeline.title-5": "We're voted UK'server Best Place to Work",
